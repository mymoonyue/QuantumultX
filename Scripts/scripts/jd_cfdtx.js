...
[task_local]
#京喜财富岛提现
59 11,23 * * * jd_cfdtx.js, tag=京喜财富岛提现, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "59 11,23 * * *" script-path=jd_cfdtx.js,tag=京喜财富岛提现

===============Surge=================
京喜财富岛提现 = type=cron,cronexp="59 11,23 * * *",wake-system=1,timeout=3600,script-path=jd_cfdtx.js

============小火箭=========
京喜财富岛提现 = type=cron,script-path=jd_cfdtx.js, cronexpr="59 11,23 * * *", timeout=3600, enable=true
 */
